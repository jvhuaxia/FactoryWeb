...
<div class="wrap">
    ...
    <div class="w735 fr">
        <div class="w713 border p0-10" style="min-height:556px; _height:556px;">
            <h1 class="title1"><span class="fr mr10 fn">当前位置：<a href="">首页</a>&nbsp;>&nbsp;关于荣江</span><em
                    class="title1-d">关于荣江</em></h1>
            <div class="pt10">
                <p>${about.des}</p>
                <div class="cl"></div>
            </div>
...
<div class="foot">
    <div class="wrap"> 热门产品：<a href="">连接器</a>&nbsp;<a href="">接插件</a>&nbsp; <a href="">接线端子</a>&nbsp; <a
        ...
        <img alt="统计器" src="image/temp/08.jpg" width="48" height="12"/></div>
</div>
</body>
</html>
