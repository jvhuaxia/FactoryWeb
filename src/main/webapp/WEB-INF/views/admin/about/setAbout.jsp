            ...
            <div class="box box-info">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="title" name="title" class="form-control" value="${about.name}"
                                   placeholder="请输入标题"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea style="height: 500px;" type="text" id="des" name="des" class="form-control"
                                      placeholder="请输入内容">${about.des}</textarea>
                        </div>
                    </div>
                </div>
