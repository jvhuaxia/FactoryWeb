...
<div class="wrap">
        ...
        <div class="w233 border bg-blue" style="height:90px; overflow:hidden;">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="submit" class="btn fb"  onclick="window.location.href = '/product/search/'+document.getElementById('name').value" value="搜索"/></td>
                </tr>
            </table>
        </div>
        <div class="h10"></div>
    ...
    <div class="w735 fr">
        <div class="w713 border p0-10" style="min-height:556px; _height:556px;">
            <h1 class="title1"><span class="fr mr10 fn">当前位置：<a href="">首页</a>&nbsp;>&nbsp;产品中心</span><em
                    class="title1-d">产品中心</em></h1>
            <div class="pt10">
                <ul class="pro-list">
                    <c:forEach items="${productList}" var="product">
                        <li><span class="pro-img"><a href="/product/${product.id}"><img alt="${product.proName}"
                                                                  src="/upload/img/${product.img}"
                                                                  width="162"
                                                                  height="118"/></a></span><span class="pro-title"><a
                                href="">${product.proName}</a></span></li>
                    </c:forEach>
                </ul>
                <div class="cl"></div>
            </div>
